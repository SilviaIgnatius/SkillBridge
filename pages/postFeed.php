    ...
    <html lang="en">
        ...
        <body>
                                ...
                                <div class="modal-content">
                                    <form action="create_post.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="submit" class="btn btn-primary share-post-button" value="Post">
                                        </div>
                                    </form>
            ...
            $posts = \classes\Post::retrievePosts($con);
                ...
                <div class="container post">
                    <div class="postWrapper">
                        ...
                        <div class="postCenter">
                            ...
                            <?php
                            // Check if there is an image path and display it
                            if (!empty($post->image_path)) {
                                echo '<img src="' . $post->image_path . '" alt="" class="postImg img-fluid">';
                            }

                            // Check if there is a video path and display it
