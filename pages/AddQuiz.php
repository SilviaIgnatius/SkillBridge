...
<html>
    ...
    <body class="body">
        <div class="container">
            ...
            <div class="container">
                <form id="questionnaire-form" action="saveQuiz.php" method="POST">
                    ...
                    <div id="questions-container">
                        <div class="question">
                            ...
                            <div class="options">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="radio" id="option11" name="correct" value="1"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="radio" id="option12" name="correct" value="2"
                                               style="display: inline-block; width: auto;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="radio" id="option13" name="correct" value="3"
                                               style="display: inline-block; width: auto;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="radio" id="option14" name="correct" value="4"
                                               style="display: inline-block; width: auto;">
        ...
        <script>
            ...
            submitFormButton.addEventListener('click', () => {
                ...
                // AJAX call to saveQuiz PHP function
                fetch('saveQuiz.php', {
                    method: 'POST',
                    body: formData
                })
